...
The [`build.yml`](.github/workflows/build.yml) workflow builds the exe on a Windows runner.
Push a `vX.Y.Z` tag to produce a **Release** with the zip attached, or run it manually from the
**Actions** tab:
